...
namespace EligibilityPlatform.Infrastructure.Repository
{
    ...
    /// Provides data access logic for currencies using the base <see cref="Repository{TEntity}"/> class.
    /// </summary>
    /// <remarks>
    ...
    public class CurrencyRepository(
        ...
        IHttpContextAccessor httpContext) : Repository<Currency>(context, httpContext), ICurrencyRepository
    {
    }
}
