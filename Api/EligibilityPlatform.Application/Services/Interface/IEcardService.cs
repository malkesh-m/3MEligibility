...
namespace EligibilityPlatform.Application.Services.Inteface
{
    ...
    public interface IEcardService
    {
        ...
        /// </summary>
        /// <param name="entityId">The unique identifier of the entity to retrieve e-cards for.</param>
        /// <returns>A list of <see cref="EcardListModel"/> objects containing all e-cards.</returns>
        List<EcardListModel> GetAll(int entityId);
        ...
        EcardListModel GetById(int entityId, int id);
        ...
        Task Add(int entityId, EcardAddUpdateModel model);
        ...
        Task<string> ImportECard(int entityId, Stream fileStream, string createdBy);
        ...
        Task<Stream> ExportECard(int entityId, List<int> ids);
    }
}
