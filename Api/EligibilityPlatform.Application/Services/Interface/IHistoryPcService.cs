...
namespace EligibilityPlatform.Application.Services.Inteface
{
    ...
    public interface IHistoryPcService
    {
        ...
        /// </summary>
        /// <param name="tenantId">The unique identifier of the entity for which to retrieve history PC records.</param>
        /// <returns>A list of <see cref="HistoryPcModel"/> objects containing all history PC records for the specified entity.</returns>
        List<HistoryPcModel> GetAll(int tenantId);

        /// <summary>
        /// Retrieves a specific history PC record by its identifier and entity identifier.
        /// </summary>
        /// <param name="tenantId">The unique identifier of the entity associated with the history PC record.</param>
        ...
        HistoryPcModel GetById(int tenantId, int id);
        ...
        /// </summary>
        /// <param name="tenantId">The unique identifier of the entity associated with the history PC records.</param>
