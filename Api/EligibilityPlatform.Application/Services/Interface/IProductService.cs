...
namespace EligibilityPlatform.Application.Services.Inteface
{
    ...
    public interface IProductService
    {
        ...
        List<ProductListModel> GetAll(int entityId);
        ...
        List<ProductModel> GetProductsByCategory(int entityId, int categoryId);
        ...
        ProductListModel GetById(int entityId, int id);
        ...
        Task<string> ImportInfo(int entityId, Stream fileStream, string createdBy);
        ...
        List<ProductIdAndNameModel> GetProductIAndName(int entityId);
        ...
        List<ProductEligibleModel> GetProductName(int entityId);
    }
}
