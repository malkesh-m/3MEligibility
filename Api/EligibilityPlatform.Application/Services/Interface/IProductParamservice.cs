...
namespace EligibilityPlatform.Application.Services.Inteface
{
    ...
    public interface IProductParamservice
    {
        ...
        Task<List<ProductParamListModel>> GetAll(int entityId);
        ...
        ProductParamListModel GetById(int productId, int parameterId, int entityId);
        ...
        ProductParamListModel GetByProductId(int productId, int entityId);
        ...
        /// <param name="entityId">The unique identifier of the entity.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task Delete(int productId, int parameterId, int entityId);
        ...
        /// <param name="entityId">The unique identifier of the entity.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task MultipleDelete(List<int> productids, List<int> parameterids, int entityId);
        ...
        Task<Stream> ExportDetails(List<int> selectedProductIds, int entityId);
        ...
        Task<string> ImportDetails(Stream fileStream, string createdBy, int entityId);
    }
}
