...
namespace EligibilityPlatform.Application.Services.Inteface
{
    ...
    public interface ICategoryService
    {
        ...
        /// </summary>
        /// <param name="entityId">The unique identifier of the entity to retrieve categories for.</param>
        /// <returns>A list of <see cref="CategoryListModel"/> objects containing the categories.</returns>
        List<CategoryListModel> GetAll(int entityId);
        ...
        CategoryListModel GetById(int entityId, int id);
        ...
        /// <returns>A task representing the asynchronous operation.</returns>
        Task<string> Remove(int entityId, int id);
        ...
        Task<Stream> ExportCategory(int entityId, List<int> selectedCategoryIds);
        ...
        Task<string> ImportCategory(int entityId, Stream fileStream, string createdBy);
