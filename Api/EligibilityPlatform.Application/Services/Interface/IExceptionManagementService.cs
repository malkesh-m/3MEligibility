...
namespace EligibilityPlatform.Application.Services.Inteface
{
    ...
    public interface IExceptionManagementService
    {
        ...
        /// </summary>
        /// <param name="entityId">The unique identifier of the entity for which to retrieve exception management records.</param>
        ...
        List<ExceptionManagementListModel> GetAll(int entityId);

        /// <summary>
        /// Retrieves a specific exception management record by its identifier and entity identifier.
        /// </summary>
        /// <param name="entityId">The unique identifier of the entity associated with the exception management record.</param>
        ...
        ExceptionManagementGetModel GetById(int entityId, int id);

        /// <summary>
        /// Adds a new exception management record for a specific entity.
        /// </summary>
        /// <param name="entityId">The unique identifier of the entity for which to add the exception management record.</param>
        ...
        Task Add(int entityId, ExceptionManagementCreateOrUpdateModel model);
        ...
        /// <returns>A task representing the asynchronous operation.</returns>
        Task Update(int entityId, ExceptionManagementCreateOrUpdateModel model);
