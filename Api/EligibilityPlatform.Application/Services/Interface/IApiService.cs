...
namespace MEligibilityPlatform.Application.Services.Interface
{
    ...
    public interface IApiService
    {
        ...
        Task<List<ApiParameterModel>> GetApiDetailsAsync(int nodeId, CancellationToken ct = default);
        ...
        Task<string> CallSoapApi(SoapApiModel model, CancellationToken ct = default);
        ...
        Task<ResponseModel> CallRestApi(ExecuteApiModel request, CancellationToken ct = default);
        ...
        Task<List<ApiParameterModel>> GetRestApiDetailsAsync(int nodeId, CancellationToken ct = default);
    }
}
