...
namespace MEligibilityPlatform.Application.Services.Interface
{
    ...
    public interface IEruleService
    {
        ...
        /// </summary>
        /// <param name="tenantId">The unique identifier of the entity associated with the Erule.</param>
        ...
        EruleListModel GetById(int tenantId, int id);
        ...
        /// </summary>
        /// <param name="tenantId">The unique identifier of the entity associated with the Erules.</param>
        ...
        Task<byte[]> DownloadTemplateEruleMaster(int tenantId);

        /// <summary>
        /// Imports Erules from a file stream for a specific entity.
        /// </summary>
        /// <param name="tenantId">The unique identifier of the entity for which to import Erules.</param>
        ...
        /// <returns>A task that represents the asynchronous operation, containing a status message string.</returns>
        Task<string> ImportErule(int tenantId, Stream fileStream, string createdBy);
        ...
        /// <param name="tenantId">The unique identifier of the entity associated with the Erule.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task PublishDraftAsync(int draftEruleId, int tenantId);
        ...
        /// <returns>A task representing the asynchronous operation.</returns>
        Task UpdateStatusAsync(int eruleId, int tenantId, bool isActive);
        ...
        Task<List<EruleListModel>> GetAllByEruleMasterId(int eruleMasterId, int tenantId);
